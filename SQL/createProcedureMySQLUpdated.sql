...
delimiter $$
create procedure updateorganization(in organization_id integer, in name varchar(255), in org_info varchar(255),
...
call addroom('hilton', 5555, 5, 'uygun', 4, 'ekstra pahali', 2, 'special');
call addroom('hilton', 5555, 5, 'uygun', 4, 'ekstra ucuz', 2, 'special');
call addroom('hilton', 555, 5, 'uygun', 4, null, 2, 'standart');
call addroom('hilton', 5555, 6, 'uygun', 4, 'ekstra yemekli', 2, 'special');
call addroom('hilton', 555, 52, 'uygun', 4, null, 2, 'standart');
...
call addorganization('Murat Boz', 'Ünlü sanaçtý Murat Boz bizlerle', 125, 2);
call addorganization('Murat Koz', 'Ünlü sanaçtý Murat Koz bizlerle', 124, 2);
call addorganization('Murat Kuzu', 'Ünlü sanaçtý Murat Kuzu bizlerle', 123, 2);
/*call updateorganization(:organization_id, :name, :org_info, :price, :hotel_id)
call updateorganization(1, 'Murat Boz', 'Ünlü sanaçtý Murat Boz bizlerle', 1255, 2);
call updateorganization(2, 'Murat Köz', 'Ünlü sanaçtý Murat Köz bizlerle', 1215, 2);
