...
as $$
	begin
	   	...
	   	insert into person(firstname, lastname, password, email, address, telephone, balance_id)
	   	values(firstname, lastname, password, mail, address, phone, (select count(*) from balance));
	   		case type
	   		when 'customer' then
	   			begin
...
$$;
call addperson('ali0', 'veli̇', '123', '0@g.c', 'mamk', '555', 21, null, 'aliveli', 'customer');
call addperson('ali1', 'veli̇', '123', '1@g.c', 'mamk', '111', 21, money '222', null, 'employee');
call addperson('ali2', 'veli̇', '123', '0@g.c', 'mamk', '555', 21, null, 'aliveli', 'employee');
call addperson('ali3', 'veli̇', '123', '1@g.c', 'mamk', '111', 21, money '222', null, 'customer');
call addperson('ali4', 'veli̇', '123', '2@g.c', 'mamk', '5555', 21, money '222', null, 'manager');
call addperson('ali5', 'veli̇', '123', '3@g.c', 'mamk', '525', 21, null, 'aliveli', 'customer');
call addperson('ali6', 'veli̇', '123', '4@g.c', 'mamk', '131', 21, money '222', null, 'employee');

/*
create or replace procedure addcustomer(firstname varchar, lastname varchar, password varchar, email varchar,
	address varchar, telephone varchar, age integer)
language 'plpgsql'
as $$
	begin
	   	insert into balance(money, date) values(null, null);
	    insert into customer(firstname, lastname, password, email, address, telephone, balance_id, age)
	   	values(firstname, lastname, password, email, address, telephone, (select count(*) from balance), age);   
	end
$$;*/

/*
create or replace procedure addregisteredcustomer(firstname varchar, lastname varchar, password varchar, email varchar,
	address varchar, telephone varchar, age integer, username varchar, person_id integer)
language 'plpgsql'
as $$
	begin
	    insert into registeredcustomer(firstname, lastname, password, email, address, telephone, balance_id, age, username, person_id)
	   	values(firstname, lastname, password, email, address, telephone, (select distinct p.balance_id from person p where p.id=person_id),
	   		age, username, person_id);   
	end
$$;
call addregisteredcustomer('ali', 'veli̇', '123', '0@g.c', 'mamk', '555', 21, 'aliveli', 1); */

/*
create or replace procedure addemployee(firstname varchar, lastname varchar, password varchar, email varchar,
	address varchar, telephone varchar, salary money)
language 'plpgsql'
as $$
	begin
	   	insert into balance(money, date) values(null, null);
	    insert into employee(firstname, lastname, password, email, address, telephone, balance_id, salary)
	   	values(firstname, lastname, password, email, address, telephone, (select count(*) from balance), salary); 
	end
$$;
call addemployee('ali', 'veli̇', '123', '0@g.c', 'mamk', '555', money '2555');*/

/*
create or replace procedure addmanager(firstname varchar, lastname varchar, password varchar, email varchar,
	address varchar, telephone varchar, salary money)
language 'plpgsql'
as $$
	begin
...
$$;
call addmanager('ali', 'veli̇', '123', '0@g.c', 'mamk', '555', money '21');*/
