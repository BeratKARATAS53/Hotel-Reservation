drop view if exists customer_view,employee_view,person_balance,customer_reservation,hotel_view,manager_view,reservation_view,organization_view,customer_all_info,employee_all_info,manager_all_info;
...
create view hotel_view as
	select id,name,address,star,telephone
	from hotel;
...
create view hotel_balance as 
	select h.id,h.name,h.address,h.balance_id,h.hotel_info,h.hotel_type,h.star,h.telephone,b.money,b.balance_date
