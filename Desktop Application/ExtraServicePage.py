...
employee = Button(ServiceRoot, text="EMPLOYEES", font=(
    "calibri", 10), bg="#d9d9d9",  command=employeePage)
...
service_id = Label(ServiceRoot, text="Service: ", font=("calibri", 9))
...
extPrice_id = Label(ServiceRoot, text="Service Price : ", font=("calibri", 9))
...
extPoint_id = Label(ServiceRoot, text="Service Point : ", font=("calibri", 9))
...
food_id = Label(ServiceRoot, text="ID: ", font=("calibri", 9))
...
food_service_id = Label(ServiceRoot, text="Service: ", font=("calibri", 9))
...
foodPrice_id = Label(ServiceRoot, text="Service Price : ", font=("calibri", 9))
...
foodPoint_id = Label(ServiceRoot, text="Service Point : ", font=("calibri", 9))
...
foodDetail_id = Label(ServiceRoot, text="Food Detail : ", font=("calibri", 9))
