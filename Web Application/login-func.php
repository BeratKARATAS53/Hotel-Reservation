...
//Eğer sorgulanan kullanıcı adı var ise bir oturum oluşturup home-login.php ye yönlendiriyoruz
//Yok ise hata verdiriyoruz. 

if (mysqli_num_rows($result) == 1) {
    $_SESSION['email'] = $email; // Initializing Session
    header("location: home-login.php"); // Redirecting To Other Page
} else {
    header("location: login-page.php"); // Redirecting To Other Page
